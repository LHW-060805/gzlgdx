 ...
 */
public class LitBook extends Book{
    public LitBook(){}
    public LitBook(int page,double discount){
        super(page,discount);
    }
    @Override
    public void showKind(){
        System.out.println("这是本文艺书！");
    }
    public void getPrice(int page,double discount){
        price=0.08*page*discount;
        System.out.println("文艺书的价格为："+price);
    }
}
